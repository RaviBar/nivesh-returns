...
const EditProfilePage = () => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    {/* Display Name Input - Added height match */}
    <InputField 
      label="Display Name"
      placeholder="**********"
      defaultValue=""
    ...
    {/* Profession Dropdown - Height adjusted */}
  ...
  <p className="text-[#585D69] text-xs mt-2 lg:-mt-2 mb-4">
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <div className="pointer-events-none absolute inset-y-0 -mt-4 right-2 flex items-center">
      ...
      <InputField
        ...
        className="flex-1 rounded-lg text-[#F1F2FF] border border-[#2C333F] h-[44px] px-4"
        label={null}
      />
    </div>
  </div>

  {/* About Field - Will stack below on mobile */}
